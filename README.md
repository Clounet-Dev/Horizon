# Horizon
[Vision 스킨](https://github.com/Wikive/Vision-Skin)을 [the tree](https://github.com/wjdgustn/thetree) 엔진에 맞춰 새롭게 제작한 스킨입니다. 엔진과 완전히 호환되지 않을 수 있으니 주의하시기 바랍니다.

## 라이선스 및 저작권
본 스킨은 **GPL-3.0 라이선스**를 따릅니다. 세부 조항은 `LICENSE` 문서를 확인하시기 바랍니다.
